/***************************************************************************
  kodowaniedxf.h - WorkField

  Przekodowanie tekstu DXF do CP1250. Wspolne dla eksportu projektu do DXF
  (NarzedziaProjektu::eksportujDxf) i modulow, ktore dopisuja do rysunkow
  (inwentaryzacja drzew). Tylko Qt.
 ...
 ***************************************************************************/
#ifndef KODOWANIEDXF_H
#define KODOWANIEDXF_H
