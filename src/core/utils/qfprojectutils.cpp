...
bool QfProjectUtils::saveProject( QgsProject *project )
{
...
bool QfProjectUtils::saveProjectAs( const QString &filePath, QgsProject *project )
{
  QgsProject *p = project ? project : QgsProject::instance();
...
QString QfProjectUtils::projectFilePath( QgsProject *project )
{
  QgsProject *p = project ? project : QgsProject::instance();
  return p ? p->fileName() : QString();
}

bool QfProjectUtils::isProjectDirty( QgsProject *project )
{
  QgsProject *p = project ? project : QgsProject::instance();
