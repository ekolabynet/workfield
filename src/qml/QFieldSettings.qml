...
Page {
  ...
  Component.onCompleted: {
    ...
    networkSettings.syncFromSettings();
  }
  ...
  ColumnLayout {
    ...
    QfTabBar {
      id: bar
      model: [qsTr("Indeks"), qsTr("General"), qsTr("Positioning"), qsTr("Variables")]
    ...
    SwipeView {
      QfSettingsIndex {
        t: Theme
        onCategorySelected: (categoryId) => console.log("wybrano:", categoryId)
      }
      id: swipeView
        ...
        ScrollView {
          ...
          ColumnLayout {
            ...
            QfSettingsInterface {
              ...
              rowDelegate: listItem
              onOpenLocatorSettings: { locatorSettings.open(); locatorSettings.focus = true; }
