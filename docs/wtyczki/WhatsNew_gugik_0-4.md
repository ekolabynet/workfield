...
```
https://raw.githubusercontent.com/ekolabynet/workfield/plugins/workfield-gugik-v0.4.zip
```

## Co się zmieniło

- docs: GUGiK v0.3 — co sprawdzic po instalacji (restart, Settings, stara warstwa w projekcie)
- docs: nota i QR dla GUGiK v0.3; skrypt wydawania wtyczek jednym poleceniem
