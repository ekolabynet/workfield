...
export APP_VERSION_NUM="${APP_VERSION_NUM:-0.11.0}"
...
export APK_VERSION_CODE=${APK_VERSION_CODE:-1146} # bN gubi sie w awk
...
export APP_VERSION_STR="${APP_VERSION_STR:-$APP_VERSION_NUM.b46 - $APP_CODENAME}"
